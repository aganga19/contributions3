...
// Pin gnostic-models to a version compatible with kube-openapi's yaml import path
...
// Exclude v0.34.0 and related packages as they change signatures
exclude k8s.io/apiserver v0.34.0

exclude k8s.io/apiextensions-apiserver v0.34.0

exclude k8s.io/component-base v0.34.0

exclude k8s.io/kms v0.34.0

exclude k8s.io/api v0.34.0

exclude k8s.io/apimachinery v0.34.0

exclude k8s.io/client-go v0.34.0

exclude k8s.io/kube-openapi v0.0.0-20250710124328-f3f2b991d03b

exclude k8s.io/utils v0.0.0-20250604170112-4c0f3b243397

// Pin otelgrpc to a version compatible with k8s v0.33.3
